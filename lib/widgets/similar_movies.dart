...
import 'package:flutterblocapp/bloc/get_similar_movies_bloc.dart';
...
class SimilarMovies extends StatefulWidget {
  ...
  @override
  _SimilarMoviesState createState() => _SimilarMoviesState(this.id);
}
...
class _SimilarMoviesState extends State<SimilarMovies> {
  ...
  void initState() {
    super.initState();
    similarMoviesBloc.getSimilarMovies(this.id);
  }
